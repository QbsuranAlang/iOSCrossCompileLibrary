#!/bin/bash
#  Automatic build script for libnet
...
/usr/bin/curl -L -O https://downloads.sourceforge.net/project/libnet-dev/${LIBNAME}-${VERSION}.tar.gz >/dev/null
fi
...
copy_file "bin/libnet-config"
copy_dir "include"
lipo_fat "lib/libnet.a"
copy_dir "share"
